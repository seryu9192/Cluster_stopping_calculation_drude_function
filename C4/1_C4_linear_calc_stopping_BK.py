#0_C4_calc_stopping_BK.py: Brandt-Kitagawaモデルを3原子クラスターの阻止能公式に適用し、イオンに対する阻止能を計算する(積分はscipy.integrateを利用)
...
q_ave_path = os.path.join(input_dir, '0_C4_linear_average_charge.txt')
param_path = r'./param_C4_linear.json'
...
def main():
    ...
    #ファイルに書き込み
    output_filename = 'E={}keV_atom_C4_linear_{}.txt'.format(E_0, target)
