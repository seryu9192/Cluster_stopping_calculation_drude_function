...
# It's not needed for single ion calculation!
...
q = [0]     #average charges
lamb = [0]  #screening parameters for Brandt-Kitagawa model
...
def func(k):
    ...
    #cross terms are not needed for single ion calculation!
    ##for i in range(len(q)):
...
def calc_stopping_BK():
    #It's not needed for single ion!
...
def main():
    ...
    #ファイルに書き込み
    output_filename = 'E={}keV_atom_C1_{}.txt'.format(E_0, target)
