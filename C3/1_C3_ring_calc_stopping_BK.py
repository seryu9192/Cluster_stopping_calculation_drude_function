#0_C3_ring_calc_stopping_BK.py: Brandt-Kitagawaモデルを3原子クラスターの阻止能公式に適用し、イオンに対する阻止能を計算する(積分はscipy.integrateを利用)
# ring structure (n=3)
...
def main():
    ...
    #ファイルに書き込み
    output_filename = 'E={}keV_atom_C3_ring_{}.txt'.format(E_0, target)
