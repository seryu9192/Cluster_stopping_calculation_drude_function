#1_C3_linear_calc_stopping_BK.py: Brandt-Kitagawaモデルを3原子クラスターの阻止能公式に適用し、イオンに対する阻止能を計算する(積分はscipy.integrateを利用)
...
def main():
    ...
    #ファイルに書き込み
    output_filename = 'E={}keV_atom_C3_linear_{}_ave_theta.txt'.format(E, target)
