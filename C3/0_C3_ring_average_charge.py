# C3_ring_average_charge.py : calculate ring C3 average charge using Kaneko model(Self-consistent calculation)
...
#filepath
working_dir = './'
param_filename = 'param_C3_ring.json'
...
def main():
    ...
    #save as a text file
    output_filename = '0_C3_ring_average_charge.txt'
    ...
    #y axis
    ax.set_ylabel('$q$')
    ax.text(0.02, 0.9, 'ring C$_3$($E$ = {} keV/atom)'.format(E), transform=ax.transAxes)
