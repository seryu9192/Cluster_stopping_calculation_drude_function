#1_He1_calc_stopping_BK.py: Brandt-Kitagawaモデルを阻止能公式に適用し、イオンに対する阻止能を計算する(積分はscipy.integrateを利用)
...
q_ave_path = os.path.join(input_dir, 'He1_average_charge.json')

param_path = r'./param_He1.json'
...
def main():
    ...
    #ファイルに書き込み
    output_filename = 'E={}keV_atom_He1_{}.txt'.format(E, target)
