# H_average_charge.py : calculate H average charge using Kaneko model
...
def main():
    ...
    v_bind = 1.045*Z_PROTON**(2/3)

    # calc average charge
    q = Z_PROTON * 2/sqrt(pi) * integrate.quad(lambda x: exp(-x**2), 0, sqrt(3/8)*v/v_bind)[0]
    print("E = {} keV".format(E))
    print("v = {} au".format(v))    
    print("q_ave =", q)

    #save as a json file
    output_filename = 'H_average_charge.json'
